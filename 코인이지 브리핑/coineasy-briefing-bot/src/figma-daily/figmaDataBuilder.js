...
async function fetchTrending() {
    ...
    try {
          // CMC Trending: most-visited (가장 많이 조회된 코인)
      const data = await fetchJson(
              'https://pro-api.coinmarketcap.com/v1/cryptocurrency/trending/most-visited?limit=3',
        {
                  headers: {
          ...
          return coins.map((c) => {
                  ...
                  return {
                            ...
                            name: c.name || '',
                            change_24h: Math.round((quote.percent_change_24h || 0) * 100) / 100,
                  };
          });
    } catch (e) {
