...
const FIGMA_BOT_TOKEN = process.env.COINEASY_FIGMA_BOT_TOKEN
  || process.env.TELEGRAM_BOT_TOKEN;  // fallback: 기존 봇 토큰 재사용
const MANAGER_CHAT_ID = process.env.COINEASY_MANAGER_CHAT_ID
  || process.env.TELEGRAM_CHAT_ID;    // fallback: 기존 채팅방
