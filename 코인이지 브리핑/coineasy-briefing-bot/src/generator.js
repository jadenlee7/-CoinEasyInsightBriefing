...
6. 🚀 트렌딩 코인 TOP 3
7. 🧠 오늘의 인사이트 (데이터 기반 시장 해석 1-2줄)
8. ✅ 오늘의 액션 아이템 (2-3개 구체적 체크리스트)
9. 마무리: "코인이지와 함께 오늘도 이지하게! 🫡"
...
- **절대 금지**: 텔레그램 URL, X URL, 채팅방/공지방/소통방 링크, 해시태그 추가 금지 (코드가 자동으로 footer 붙임)
...
2. BTC 카드 (8초): 비트코인과 이더리움 가격 변동 설명
3. 지표 카드 (8초): 공포탐욕 지수와 김치 프리미엄 해석 + 이 지표가 뜻하는 의미 한마디
4. 트렌딩 카드 (6초): 오늘 주목할 코인 1-2개 + 왜 주목해야 하는지
5. 아웃트로 (5초): 오늘의 핵심 액션 아이템 한 줄 + "코인이지 텔레그램에서 매일 아침 브리핑 받아보세요"
...
## 자막 분할
나레이션을 8-10개의 짧은 자막 라인으로 분할해서 제공
각 라인은 10-20자 이내
